...
<a href="https://buymeacoffee.com/okandemir" target="_blank">
...
- Open the downloaded file and drag **Unplug Alarm** into your `Applications` folder.
- On first launch, macOS may show a security prompt; you might need to allow the app under **System Settings → Privacy & Security**.
...
- **Email**: [me@okandemir.net](mailto:me@okandemir.net)
